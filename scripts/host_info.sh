...
get_hostname() {
 # $(YOUR_CMD) equivalent to your `YOUR_CMD`
...
#Step 1: parse the data and setup variables 
get_cpu_number
get_cpu_architecture
get_cpu_model
get_cpu_mhz
...
insert_stmt=$(cat <<-END
INSERT INTO host_info (hostname, cpu_number, cpu_architecture, cpu_model, l2_cache, total_mem, "timestamp") VALUES('${hostname}', ${cpu_number}, '${cpu_architecture}', '${cpu_model}', ${cpu_mhz}, ${L2_cache}, ${total_mem}, '${timestamp}');
END
)
echo $insert_stmt
